...
export const TableAllNonActivePatients = ({ pazienti_all }) => {
    ...
    //         rows.push({ id: index + 1, identification_code: paziente.identification_code, minor: paziente.minor, ora_ingresso: paziente.ora_ingresso, ora_uscita: paziente.ora_uscita})
